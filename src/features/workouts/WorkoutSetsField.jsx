...
function WorkoutSetsField({
  ...
  return (
    <div className='relative ml-6 grid md:ml-7 md:grid-cols-2'>
      <div>
        <div className='grid grid-cols-[0.3fr_0.3fr_0.15fr] place-items-center gap-2 text-xs uppercase text-primary'>
        ...
        <div className='space-y-1'>
          {sets.map((set, index) => (
            <div
              className='relative grid grid-cols-[0.3fr_0.3fr_0.15fr] place-items-center gap-2 md:gap-4'
              key={set.id}
            >
              <Label
                htmlFor={`${set.id}-reps`}
              ...
              <Input
                ...
                validation={{
                  ...
                  min: {
                    value: 0,
                    message: 'Weight field should be at least 0',
                  },
                }}
                error={
                  errors?.exercises?.[exerciseIndex]?.sets?.[index]?.weight
                }
              />
      ...
      {isSearching ? (
        ...
        lastExercise && (
          <div className='w-fit max-w-[80%] text-xs text-secondary'>
            <div className='mt-3 rounded bg-secondary p-2 shadow-sm md:mt-4 md:p-4 md:text-sm'>
              <span> Previous {lastExercise.exercise_name}</span>
